...
public class CircularProgressButton extends AppCompatButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mStrokeWidth = (int) getContext().getResources().getDimension(R.dimen.dp_4);
    ...
    private StrokeGradientDrawable createDrawable(int color) {
        GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.bg_cpb).mutate();
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int blue = getColor(R.color.colorPrimary);
            int white = getColor(R.color.colorWhite);
